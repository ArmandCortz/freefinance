...
@section('main-content')
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            @if ($data->attached)
                <a href="/attached/edit/{{ $data->attached->id }}" class="btn btn-primary  waves-effect waves-light"
                    style="float: right;"><i class="fa fa-paperclip"></i> Editar Adjunto</a>
            @else
                <a href="/attached/create/{{ $data->id }}" class="btn btn-primary  waves-effect waves-light"
                    style="float: right;"><i class="fa fa-paperclip"></i> Agregar Adjunto</a>
            @endif
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form id="search-form" role="form" action="/summary/editar/{{ $data->id }}" method="post"
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" step="any" required maxlength="200" data-mask-reverse="true" step="0.01"
                        name="amount" value="<?php echo $data->amount; ?>" class="form-control" placeholder="Monto del Movimiento">
                ...
                <div class="form-group">
                    ...
                    <input type="text" maxlength="200" name="tax" value="<?php echo $data->tax; ?>" data-mask-reverse="true"
                        class="form-control" placeholder="Impuesto">


                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">N° Ref</label>
                    <input maxlength="200" name="factura" value="{{ $data->factura }}" type="text" class="form-control"
                        placeholder="N° Ref">
                </div>
                <div class="form-group">
