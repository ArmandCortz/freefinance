            ...
            <div class="col-md-12 ">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Grafica de movimientos</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <center><label>Abonos&nbsp; </label><label class="entrada">&nbsp;&nbsp;&nbsp;&nbsp; </label>
                            &nbsp;&nbsp; <label>Retiros &nbsp;</label><label class="salida">
                                &nbsp;&nbsp;&nbsp;&nbsp;</label></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Saldo Disponible</h3>
                            ...
                            <tbody>
                                @foreach ($summary as $summarys)
                                    <tr>
                                        ...
                                        <td>
                                            <n class="n">{{ number_format($summarys->total, 2, ',', '.') }}
                                            </n> {{ $divisa->value }}
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <tbody>
                                @foreach ($account as $accounts)
                                    <tr>
                                        ...
                                        <td>{{ number_format($accounts->amount, 2, ',', '.') }} {{ $divisa->value }}
                                        </td>
                                        <td>{{ $accounts->tax }}</td>
