                            ...
                            <div class="col-md-12">
                                <div class="box box-admin-border">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 class="box-title"><b>Bitacora</b></h3>
                                        ...
                                        <div id="lista_item_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                            <div class="row ">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <table id="bitacora" class="display" cellspacing="0"
                                                        width="100%">
                                                        <thead>
                                                            <tr>
                                                                <th>ID</th>
                                                            ...
                                                            @foreach ($bitacora as $bitacoras)
                                                                <tr>
                                                                    ...
                                                                    @if ($bitacoras->type == 'add')
                                                                        <td><small class="label  bg-primary"><i
                                                                                    class="fa fa-sort-up"></i></small>
                                                                            Agrego</td>
                                                                    @elseif($bitacoras->type == 'out')
                                                                        <td><small class="label  bg-red"><i
                                                                                    class="fa fa-sort-desc"></i></small>
                                                                            Retiro </td>
                                                                    @elseif($bitacoras->type == 'update')
                                                                        <td><small class="label alert-warning"><i
                                                                                    class="fa fa-edit"></i></small>
                                                                            Editado </td>
                                                                    @elseif($bitacoras->type == 'transfer')
                                                                        <td><small class="label alert-warning"><i
                                                                                    class="fa fa-exchange"></i></small>
                                                                            Transferido </td>
																	@else
                                                                        <td><small class="label  bg-red"><i
                                                                                    class="fa fa-trash"></i></small>
                                                                            ELiminado</td>
                                                                    @endif
