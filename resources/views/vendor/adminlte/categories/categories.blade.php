                            ...
                            <div class="col-md-12">
                                <div class="box box-admin-border">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 class="box-title"><b>Categorias</b></h3>

                                        <a class="btn btn-primary " style="float: right;" href="/categories/create"> <i
                                    ...
                                    <div class="box-body responsive-table">
                                        ...
                                        <div id="lista_item_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table id="categories" class="display" cellspacing="0"
                                                        width="100%">
                                                        <thead>
                                                            <tr>
                                                                <th>Id</th>
                                                            ...
                                                            @foreach ($categories as $categoriess)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if ($categoriess->id > 0)
                                                                            <form role="form"
                                                                                action="/categories/eliminar/{{ $categoriess->id }}"
                                                                                method="post" enctype="multipart/form-data">
                                                                                {{ method_field('DELETE') }}
                                                                                {{ csrf_field() }}
                                                                                <a class="btn btn-sm btn-default"
                                                                                    href="/categories/edit/{{ $categoriess->id }}"><i
