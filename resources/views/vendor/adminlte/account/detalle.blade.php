                            ...
                            <div class="col-md-12">
                                <div class="box box-admin-border">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 class="box-title"><b>Movimientos de: {{ $nombre->name }}</b></h3>
                                                            ...
                                                            @foreach ($summary as $summarys)
                                                                <tr>
                                                                    ...
                                                                    @if ($summarys->type == 'add')
                                                                        <td>Abono <small
                                                                                class="label pull-right bg-primary"><i
                                                                                    class="fa fa-sort-up"></i></small></td>
                                                                    @else
                                                                        <td>Retiro <small class="label pull-right bg-red"><i
                                                                                    class="fa fa-sort-desc"></i></small>
                                                                        </td>
                                                                    @endif
                                                                    <td>{{ number_format($summarys->amount, 2, '.', ',') }}
                                                                        {{ $divisa->value }}</td>
                                                                    <td>{{ number_format($summarys->tax, 2, '.', ',') }}
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <form role="form"
                                                                            action="/summary/eliminar/{{ $summarys->id }}"
                                                                            ...
                                                                            <button
                                                                                onclick='if(confirmDel() == false){return false;}'
