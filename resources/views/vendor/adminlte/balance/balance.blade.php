                            ...
                            <div class="col-md-12">
                                <div class="box box-admin-border">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 class="box-title"><b>Balance global Categorias</b></h3>
                                        ...
                                        <div id="lista_item_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    ?>
                                                    <table style="font-size: <?php echo $valorletra; ?>" id="balance"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @if ($timeline )
                                                                <tr style="background-color: #c6e0ec; color: #111">
                                                                    <td style="background-color: #a2c5d5;">Totales Generales</td>
                                                                    <?php $totall = 0; ?>
                                                                    @foreach ($timeline as $t => $valor)
                                                                        @if ($valor)
                                                                            <td>
